             ...
             <a href="{{ url('/fourwheeler') }}">
              ...
              <div class="card-body">
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    @foreach ($fourwheelers as $four )
                      <tr>
                        <th>{{ $four->id }}</th>
                        <td>{{ $four->company_name }}</td>
                        <td>{{ $four->model_name }}</td>
                        <td>{{ $four->fuel_type }}</td>
                        <td><img width="100px" src="{{ $four->image }}"/> </td>

                        <td>
                          <a href="{{ url('../editfourwheeler', $four->id) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                          <a href="{{ url('../deletefourwheeler', $four->id) }}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i></a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>

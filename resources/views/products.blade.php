      ...
      <div class="col-sm-6">
        <div class="card">
          <div class="card-header">
            <h4>Products
                <a href="../addproduct" class="btn btn-info btn-sm">
                    Add Product
                </a>
              ...
              <tbody>
                @foreach ($products as $product )
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('../editproduct', $product->id) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                      <a href="{{ url('../deleteproduct', $product->id) }}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>

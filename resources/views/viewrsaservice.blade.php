...
<div class="content-header">
   ...
   <tr>
     ...
     <td>
      <a href="{{ url('../rsaservice', $item->id) }}" class="btn btn-success btn-sm"><i class="fa-solid fa-eye"></i></a>
      <a href="{{ url('../editrsasubserviceform', $item->id) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>

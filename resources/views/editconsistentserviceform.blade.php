          ...
          <div class="col-sm-6">
            ...
            @method('PUT')
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{ $consistentservice->name }}" value="{{ old('name') }}">
              ...
              <div class="mb-3">
                ...
                <input type="file" class="form-control" id="image" name="image" value="{{ $consistentservice->image }}" value="{{ old('image') }}">
                <span class="text-danger">
                  @error('image')
                    {{ $message }}
                  @enderror
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="description" name="description" value="{{ $consistentservice->description }}" value="{{ old('description') }}">
                <span class="text-danger">
                  @error('description')
                    {{ $message }}
                  @enderror

      ...
      <div class="col-sm-6">
        <div class="card">
            <div class="card-header">
              <h4>Parts
                  <a href="../addpart"  class="btn btn-primary float-right btn-sm m-1">
                      Add Part
                 </a>
                 {{-- <a href="../bulkupload"  class="btn btn-success float-right btn-sm m-1">
                    Bulk Upload
               </a> --}}
              </h4>
            </div>
                ...
                <tbody>
                  @foreach ($parts as $part )
                    <tr>
                      <th>{{ $part->id }}</th>
                      <td>{{ $part->name }}</td>
                      <td><img width="100px" src="{{ $part->image }}"/> </td>
                      <td>{{ $part->part_number }}</td>
                      <td>{{ $part->description }}</td>
                      <td>{{ $part->charge_amount }}</td>
                      <td>{{ $part->tax }}</td>
                      <td>{{ $part->spare_labour }}</td>
                      <td>{{ $part->mrp }}</td>
                      <td>{{ $part->hsn_code }}</td>
                      <td>{{ $part->current_stock }}</td>
                      <td>{{ $part->is_active }}</td>
  
                      <td>
                        <a href="{{ url('../editproduct', $part->id) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="{{ url('../deleteproduct', $part->id) }}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i></a>
                      </td>
                    </tr>
                  @endforeach
                </tbody>

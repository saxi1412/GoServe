      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('/parts') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      <div class="form-group">
                         <label for="upload-file">Bulk Upload</label>
                         <input type="file" name="upload-file" class="form-control">
                      </div>
                      <input class="btn btn-success" type="submit" value="Bulk Upload" name="submit">
                  </form>

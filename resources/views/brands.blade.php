          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-header">
                <h4>Brands
                    <a href="../addbrand" data-bs-toggle="modal" data-bs-target="#AddVehicleModal" class="btn btn-primary float-right btn-sm">
                        Add Brand
                       </a>
                </h4>
              </div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    @foreach ($brands as $brand )
                      <tr>
                        <th>{{ $brand->id }}</th>
                        <td><img width="100px" src="{{ $brand->image }}"/> </td>
                       ...
                       <td>
                        <td>
                            <a href="{{ url('../editbrand', $brand->id) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a href="{{ url('../deletebrand', $brand->id) }}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i></a>
                        </td>   
                      </tr>
                    @endforeach
                  </tbody>

          ...
          <div class="col-sm-6">
            ...
            <div class="card-body">
              <table class="table table-bordered table-striped">
                ...
                @foreach ($consistentservice as $item)
             <tr>
               <td>{{ $item->id }}</td>
               <td>{{ $item->name }}</td>
               ...
               @endif
               <td>
                <a href="{{ url('../viewrsaservice', $item->id) }}" class="btn btn-success btn-sm"><i class="fa-solid fa-eye"></i></a>    
                <a href="{{ url('../editconsistentserviceform', $item->id) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
              </td>
             </tr>

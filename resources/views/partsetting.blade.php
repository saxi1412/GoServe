          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-header">
                <h4>Parts
                    <a href="../addpartsetting" data-bs-toggle="modal" data-bs-target="#AddVehicleModal" class="btn btn-primary float-right btn-sm">
                        Add Part
                       </a>
                </h4>
              </div>
                  ...
                  <tbody>
                    @foreach ($partsetting as $part )
                      <tr>
                       ...
                       <td>
                        <td>
                            <a href="{{ url('../editpartsetting', $part->id) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a href="{{ url('../deletepartsetting', $part->id) }}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i></a>
                        </td> 
                      </tr>
                    @endforeach
                  </tbody>
